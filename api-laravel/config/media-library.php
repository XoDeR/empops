...
return [
     ...
     */
    // Note: Media Library Pro is not installed in this repo, so we use a local
    // temp-upload model for chunked/stateless upload flows.
    'temporary_upload_model' => \Modules\Uploads\Models\TemporaryUpload::class,
